...
To document a security concern, communication is facilitated with the project curators:
  ...
  - **Method**: Reports are submitted via the repository’s [GitHub Issues](https://github.com/Amey-Thakur/TSF-UNSUPERVISED-MACHINE-LEARNING/issues) interface to formally record security-related findings.
...
## Implementation Context: Unsupervised Machine Learning

This project consists of an implementation of a KMeans Clustering algorithm using the Iris dataset to predict the optimum number of clusters, developed as part of a Data Science and Business Analytics internship at The Sparks Foundation.
